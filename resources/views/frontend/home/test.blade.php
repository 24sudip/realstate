...
<body>
    ...
    <figure class="image-box"><img src="{{ asset('frontend_assets') }}/images/resource/property-details-1.jpg" alt=""></figure>
    <figure class="image-box"><img src="{{ asset('frontend_assets') }}/images/resource/property-details-1.jpg" alt=""></figure>
                ...
                <div class="acc-content current">
                    <div class="content-box">
                        ...
                        <figure class="image-box">
                            <img src="{{ asset('frontend_assets') }}/images/resource/floor-1.png" alt="">
                        </figure>
                    </div>
                </div>
            </li>
