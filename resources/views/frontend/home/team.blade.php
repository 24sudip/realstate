    ...
    <div class="auto-container">
        ...
        <div class="single-item-carousel owl-carousel owl-theme owl-dots-none nav-style-one">
            ...
            <div class="team-block-one">
                <div class="inner-box">
                    <figure class="image-box"><img src="{{ (!empty($item->photo)) ? url('upload/agent_photos/'.$item->photo) : url('upload/no_image.jpg') }}" alt="agent" style="width: 370px; height: 370px;"></figure>
