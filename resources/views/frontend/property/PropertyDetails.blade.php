                    ...
                    <div class="property-details-content">
                        ...
                        <div class="statistics-box content-widget">
                            ...
                            <figure class="image-box">
                                <a href="{{ asset('frontend_assets') }}/images/resource/statistics-1.png" class="lightbox-image" data-fancybox="gallery"><img src="{{ asset('frontend_assets') }}/images/resource/statistics-1.png" alt=""></a>
                            </figure>
                        </div>
                    ...
                    <div class="property-sidebar default-sidebar">
                        <div class="author-widget sidebar-widget">
                            <div class="author-box">
                                <figure class="author-thumb"><img src="{{ asset('frontend_assets') }}/images/resource/author-1.jpg" alt=""></figure>
                                <div class="inner">
                                    <h4>Michael Bean</h4>
                                    <ul class="info clearfix">
