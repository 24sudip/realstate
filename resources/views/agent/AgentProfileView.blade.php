    ...
    <div class="row profile-body">
        ...
        <div class="card rounded">
            ...
            <div class="d-flex align-items-center justify-content-between mb-2">
                <div>
                <img class="wd-100 rounded-circle" src="{{ (!empty($profile_data->photo)) ? url('upload/agent_photos/'.$profile_data->photo) : url('upload/no_image.jpg') }}" alt="profile">
                <span class="h4 ms-3">{{ $profile_data->user_name }}</span>
                </div>
            </div>
            <div class="mt-3">
                  ...
                  <div class="card-body">
                    ...
                    @csrf
                        <div class="mb-3">
                            ...
                            <input type="text" name="user_name" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Username" value="{{ $profile_data->user_name }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputPhone1" placeholder="Phone" name="phone"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="image_id" name="photo">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputImage1" class="form-label"></label>
                            <img class="wd-80 rounded-circle" src="{{ (!empty($profile_data->photo)) ? url('upload/agent_photos/'.$profile_data->photo) : url('upload/no_image.jpg') }}" alt="profile" id="showImage">
                        </div>
