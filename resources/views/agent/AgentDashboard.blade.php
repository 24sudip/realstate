...
<head>
    ...
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="{{ asset('dashboard_assets/vendors') }}/flatpickr/flatpickr.min.css">
    <!-- End plugin css for this page -->
    ...
    <!-- Layout styles -->
    <link rel="stylesheet" href="{{ asset('dashboard_assets/css') }}/demo2/style.css">
    <!-- End layout styles -->
...
<body>
    ...
    <script src="{{ asset('dashboard_assets/vendors') }}/flatpickr/flatpickr.min.js"></script>
...
<script src="{{ asset('dashboard_assets/js/code/code.js') }}"></script>
<script src="{{ asset('dashboard_assets/js/code/validate.min.js') }}"></script>
