                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="short_descrip" class="form-control" id="exampleFormControlTextarea1" rows="3">{{ $property->short_descrip }}</textarea>
                                        </div>
                                    </div><!-- Col -->
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            <label class="form-label">Long Description</label>
                                            <textarea name="long_descrip" class="form-control" name="tinymce" id="tinymceExample" rows="10">{!! $property->long_descrip !!}</textarea>
                                        </div>
                                    </div><!-- Col -->
                                </div><!-- Row -->
                                <div class="mb-3">
									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<tr>
                                                <td>{{ $key+1 }}</td>
												<td class="py-1">
													<img src="{{ asset('upload/property/multi-image') }}/{{ $m_img->photo_name }}" alt="image" style="width: 50px;height: 50px;">
												</td>
												<td>
													<input type="file" class="form-control" name="multi_img[{{ $m_img->id }}]">
												</td>
												<td>
                                                    <input type="submit" class="btn btn-primary px-4" value="Update Image">
                                                    <a href="{{ route('agent.delete.property.multiImage', $m_img->id) }}" class="btn btn-danger" id="delete">Delete</a>
                                                </td>
											</tr>
                                            @endforeach
										</tbody>
