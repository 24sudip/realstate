    ...
    <tr>
        <td>
          <p class="font" style="margin-left: 20px;">
           <strong>Name:</strong> {{ $package_history->relation_to_user->name }} <br>
           <strong>Email:</strong> {{ $package_history->relation_to_user->email }} <br>
           <strong>Phone:</strong> {{ $package_history->relation_to_user->phone }} <br>

           <strong>Address:</strong>{{ $package_history->relation_to_user->address }}
        ...
        <td>
          <p class="font">
            ...
            Order Date: {{ $package_history->created_at }} <br>
