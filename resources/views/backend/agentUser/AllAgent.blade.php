                ...
                <div class="card-body">
                    ...
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td>{{ $key+1 }}</td>
                            <td><img src="{{ (!empty($item->photo)) ? url('upload/agent_photos/'.$item->photo) : url('upload/no_image.jpg') }}" style="width: 70px;height: 70px;">
                            </td>
                            <td>{{ $item->name }}</td>
                            <td>{{ $item->role }}</td>
                            <td>
                            ...
                            <td>
                                <input type="checkbox" class="toggle-class" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="Inactive" data-id="{{ $item->id }}"
                                {{ $item->status ? 'checked' : '' }}>
                            </td>
                            <td>
