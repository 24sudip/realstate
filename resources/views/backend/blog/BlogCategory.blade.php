                    ...
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-inverse-warning" data-bs-toggle="modal" data-bs-target="#catedit" id="{{ $item->id }}" onclick="categoryEdit(this.id)">Edit</button>
      ...
      <div class="modal-body">
        ...
        @csrf
            <div class="form-group mb-3">
                ...
                <input type="text" name="category_name" class="form-control" placeholder="Blog Category Name">
            </div>
